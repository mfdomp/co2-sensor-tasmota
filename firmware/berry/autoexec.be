...
def setup_gpio()
  try
    ...
    if cur!=nil && cur.find('I2C SDA1')!=nil return false end
  except .. as e,m
    print('setup_gpio check err: '+str(e))
  end
  tasmota.cmd('GPIO21 640')
  tasmota.cmd('GPIO22 608')
  tasmota.cmd('GPIO18 736')
  tasmota.cmd('GPIO19 672')
  tasmota.cmd('GPIO23 704')
  tasmota.cmd('GPIO5 6720')
  print('GPIOs configurados - reiniciando...')
  tasmota.cmd('Restart 1')
  return true
end
var FONT=bytes("0000000000"+"00005F0000"+"0007000700"+"147F147F14"+"242A7F2A12"+"2313086462"+"3649552250"+"0005030000"+"001C224100"+"0041221C00"+"14083E0814"+"08083E0808"+"0050300000"+"0808080808"+"0060600000"+"2010080402"+"3E5149453E"+"00427F4000"+"4261514946"+"2141454B31"+"1814127F10"+"2745454539"+"3C4A494930"+"0171090503"+"3649494936"+"064949291E"+"0036360000"+"0056360000"+"0814224100"+"1414141414"+"0041221408"+"0201510906"+"3249494924"+"7E1111117E"+"7F49494936"+"3E41414122"+"7F4141221C"+"7F49494941"+"7F09090901"+"3E4149497A"+"7F0808087F"+"00417F4100"+"2040413F01"+"7F08142241"+"7F40404040"+"7F0204027F"+"7F0408107F"+"3E4141413E"+"7F09090906"+"3E4151215E"+"7F09192946"+"4649494931"+"01017F0101"+"3F4040403F"+"1F2040201F"+"3F4038403F"+"6314081463"+"0708700807"+"6151494543"+"007F414100"+"0204081020"+"0041417F00"+"0402010204"+"4040404040"+"0001020400"+"2054545478"+"7F48444438"+"3844444420"+"384444487F"+"3854545418"+"087E090102"+"0C5252523E"+"7F08040478"+"00447D4000"+"2040443D00"+"7F10284400"+"00417F4000"+"7C04180478"+"7C08040478"+"3844444438"+"7C14141408"+"081414187C"+"7C08040408"+"4854545420"+"043F444020"+"3C4040407C"+"1C2040201C"+"3C4030403C"+"4428102844"+"0C5050503C"+"4464544C44"+"0008364100"+"00007F0000"+"0041360800"+"1008081008")
...
def ssd_init()
  for c:[0xAE,0xD5,0x80,0xA8,0x3F,0xD3,0x00,0x40,0x8D,0x14,0x20,0x02,0xA1,0xC8,0xDA,0x12,0x81,0xCF,0xD9,0xF1,0xDB,0x40,0xA4,0xA6,0xAF]
    ssd_cmd(c)
  end
end
...
def calibrar_scd41(ppm)
  var result=tasmota.cmd('SCD40Cal '+str(ppm))
  print('Calibracao SCD41: '+str(result))
end
def reset_scd41()
  wire1.write(0x62,0x3F,0x86,1)
  tasmota.set_timer(500,def()
    wire1.write(0x62,0x36,0x32,1)
    tasmota.set_timer(1200,def()
      wire1.write(0x62,0x21,0xB1,1)
      print('SCD41 factory reset concluido')
    end)
  end)
end
def sync_rtc()
  var now=tasmota.rtc()
  var utc=now['utc']
  if utc<1000000000 print('NTP nao sincronizado, RTC preservado') return end
  var ts=utc-10800
  var sec=ts%60
  ts=ts/60
  var min=ts%60
  ...
  wire1.write(0x68,0x00,tobcd(sec),1)
  wire1.write(0x68,0x01,tobcd(min),1)
  wire1.write(0x68,0x02,tobcd(hour),1)
  wire1.write(0x68,0x04,tobcd(day),1)
  wire1.write(0x68,0x05,tobcd(mon),1)
  wire1.write(0x68,0x06,tobcd(year),1)
  print('RTC sincronizado: '+str(day)+'/'+str(mon)+'/'+str(year+2000)+' '+str(hour)+':'+str(min)+':'+str(sec))
end
def setup_identity()
  var wf=tasmota.wifi()
  var mac=wf.find('mac','')
  if size(mac)<12 print('MAC nao disponivel ainda') return end
  var clean=''
  for i:0..size(mac)-1
...
tasmota.set_timer(20000,
def()
  if setup_gpio() return end
  setup_identity()
  sync_rtc()
  ssd_init()
  ssd_clear()
  ...
  try
    ...
    print('Boot init err: '+str(e)+' '+str(m))
  end
end)
